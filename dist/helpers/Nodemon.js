...
var NodemonHelper = (function () {
            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            return [2, reject(new Error("Process not created"))];
                        });
                    }); })];
            });
        });
    };
    NodemonHelper.down = function (processId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            if (processId) {
                                (0, tree_kill_1["default"])(parseInt(processId), "SIGKILL", function (err) { return reject(err); });
                                resolve(true);
                            }
    ...
    return NodemonHelper;
}());
exports.NodemonHelper = NodemonHelper;
